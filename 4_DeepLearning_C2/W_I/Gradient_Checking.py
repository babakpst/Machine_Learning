...
def gradient_check(x, theta, epsilon=1e-7, print_msg=False):
    ...
    # difference =                                # Step 3'
    # YOUR CODE STARTS HERE
    numerator = np.linalg.norm(backward_propagation(x, theta) - gradapprox)  # Step 1'
    denominator = np.linalg.norm(backward_propagation(x, theta))+np.linalg.norm(gradapprox)  # Step 2'
